<template>
  <table class="table table-bordered table-striped">
    <thead>
      <tr>
        <th v-if="selectType.toLowerCase() === 'checkbox'">
          <input
            type="checkbox"
            name=""
            id=""
        ...
        <th v-else-if="selectType.toLowerCase() === 'radio'"></th>
    ...
    <tbody>
      <tr :key="i" v-for="(item, i) in items">
        <td v-if="selectType.toLowerCase() === 'checkbox'">
          <input
            type="checkbox"
            name=""
            id=""
        ...
        <td v-else-if="selectType.toLowerCase() === 'radio'">
          <input
            type="radio"
            name=""
            id=""
